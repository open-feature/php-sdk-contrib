 ...
 *
 * Generated from protobuf message <code>flagd.evaluation.v2.ResolveFloatResponse</code>
 */
class ResolveFloatResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * The response value of the float flag evaluation, will be empty in the case of error.
     *
     * Generated from protobuf field <code>optional double value = 1 [json_name = "value"];</code>
     */
