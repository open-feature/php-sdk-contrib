 ...
 *
 * Generated from protobuf message <code>flagd.evaluation.v2.ResolveStringResponse</code>
 */
class ResolveStringResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * The response value of the string flag evaluation, will be unset in the case of error.
     *
     * Generated from protobuf field <code>optional string value = 1 [json_name = "value"];</code>
     */
